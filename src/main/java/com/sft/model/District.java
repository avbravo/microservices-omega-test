...
List<ActionHistory> actionHistory;
    ...
    public District(String iddistrict, Boolean active, String district, Province province, List<ActionHistory> actionHistory) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 37 * hash + Objects.hashCode(this.iddistrict);
