...
List<ActionHistory> actionHistory;
    ...
    public Tipotarjeta(Long idtipotarjeta, String tipotarjeta, Boolean active, List<ActionHistory> actionHistory) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 29 * hash + Objects.hashCode(this.idtipotarjeta);
        hash = 29 * hash + Objects.hashCode(this.tipotarjeta);
    ...
    public String toString() {
        return "Tipotarjeta{" + "idtipotarjeta=" + idtipotarjeta + ", tipotarjeta=" + tipotarjeta + ", active=" + active + ", actionHistory=" + actionHistory + '}';
    }
