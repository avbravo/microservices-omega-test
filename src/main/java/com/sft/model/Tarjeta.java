...
public class Tarjeta {
    ...
    public int hashCode() {
        ...
        hash = 29 * hash + Objects.hashCode(this.userView);
        ...
        hash = 29 * hash + Objects.hashCode(this.backlog);
        ...
        hash = 29 * hash + Objects.hashCode(this.tarea);
        hash = 29 * hash + Objects.hashCode(this.comentario);
        hash = 29 * hash + Objects.hashCode(this.etiqueta);
        hash = 29 * hash + Objects.hashCode(this.archivo);
        hash = 29 * hash + Objects.hashCode(this.impedimento);
